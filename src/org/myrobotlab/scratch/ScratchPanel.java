...
/**
 * Diese Klasse ist die Herzstï¿½ck GUI des Programms. Diese Klasse ist das
...
public class ScratchPanel extends JPanel implements MouseListener,
	...
	/**
	 * Liefert alle Elemente, die am RootElement hï¿½ngen als Bild zurï¿½ck.
	...
	/**
	 * Setzt die zugeordnete TextArea (nicht verï¿½ndern)
	 */
	...
	/**
	 * Da beim Docken mehrere Parameter zurï¿½ckgeliefert werden mï¿½ssten, wird
	 * diese Methode verwendet, um wï¿½hrend des dockVorgang berechnet, an
	...
	/**
	 * Fï¿½gt das ï¿½bergebene Renderable hinzu, so dass dieses im HauptFenster
	 * angezeigt wird.
	 * 
	 * @param r
	 */
	...
	/**
	 * Fï¿½gt ein Renderable an Position x, y in der Elementenliste hinzu und
	 * fï¿½hrt gleichzeitig ein mouseDown Event aus
	 * 
	 * @param r
	 *            Das Renderable, das hinzugefï¿½gt werden soll
	 * @param x
	 *            Koordinate x
	 * @param y
	 *            Koordinate y
	...
	/**
	 * Liefert die Gesamthï¿½he aller Elemente. Notwendig, um die ScrollBars so
	 * anzupassen, dass diese bis zu der maximalen Hï¿½he gescrollt werden
	 * kï¿½nnen.
	 * 
	 * @return
	 */
	...
	/**
	 * Berechnet die notwendige Breite und Hï¿½he fï¿½r die Darstellung aller
	...
	/**
	 * Passt die Hï¿½hen und Breiten der ScrollBars an.
	 */
	...
	/**
	 * Prï¿½ft, ob der ï¿½bergebene JavaIdentifier fï¿½r eine neue Methode
	 * mï¿½glich ist.
	 * 
	 * @param name
	 *            Name fï¿½r eine neue Methode.
	 * @throws InvalidIdentifierException
	 *             wird geworfen, falls
	 *             <ol>
	 *             <li>Der Bezeichner hat keine gï¿½ltige Javakonvention.</li>
	...
	/**
	 * ï¿½ffnet einen Tab mit dem ï¿½bergebenen Namen.
	 * 
	 * @param name
	 */
	...
	/**
	 * ï¿½ffnet ein ContextMenu an der ï¿½bergebenen Position
	 * 
	 * @param x
	...
	/**
	 * ï¿½ffnet ein ContextMenu an der ï¿½bergebenen Position, das das
	 * ï¿½bergebene Renderable bearbeiten soll.
	 * 
	 * @param elem
	...
	public void openContextMenu(Renderable elem, int x, int y,
		...
		MenuItem temp = new MenuItem("ï¿½ffnen", new OpenClickHandler(
				elem.getName()));
		temp.setEnabled(en);
		items.add(temp);
		...
		String delName = elementList ? "Lï¿½schen" : "Entfernen";
	...
	/**
	 * Lï¿½scht die Methode mit dem ï¿½bergebenen Namen.
	 * 
	 * @param name
	 *            Name der Methode, die gelï¿½scht werden soll.
	 */
	private void onDelete(String name) {
		int confirmResult = JOptionPane
				.showConfirmDialog(
						...
						"Soll die Methode \""
								+ name
								+ "\" gelï¿½scht werden? Dieser Vorgang kann nicht rï¿½ckgï¿½ngig gemacht werden!",
						"Lï¿½schen", JOptionPane.YES_NO_OPTION);
	...
	// dibo 13.08.2010
	/**
	 * Auslagerung des ï¿½bergebenen Elementes in eine Prozedur oder Funktion
	 */
	...
	/**
	 * Diese Klasse ist der LocationChangeHandler fï¿½r den vertikalen
	 ...
	 * verï¿½ndert. Dabei wird der sichtbare Bereich abhï¿½ngig von der Position
	...
	/**
	 * Diese Klasse ist der LocationChangeHandler fï¿½r den horizontalen
	 * Scrollbalken. Die darin enthaltene Methode onLocationChange() wird
	...
	/**
	 * Dieser ClickHandler wird an das ContextMenu ï¿½bergeben und die darin
	 * enthaltene Methode onClick wird aufgerufen, wenn auf das MenuItem
	 * "ï¿½ffnen" geklickt wurde und somit ein neues Tab geï¿½ffnet werden soll.
	 * 
	 * @author HackZ
	 * 
	 */
	 ...
	 * Dieser ClickHandler wird an das ContextMenu ï¿½bergeben und die darin
	 * enthaltene Methode onClick wird aufgerufen, wenn auf das MenuItem
	 * "umbenennen" geklickt wurde. Dies soll das RenameFrame ï¿½ffnen, wo der
	 ...
	 * Dieser ClickHandler wird an das ContextMenu ï¿½bergeben und die darin
	 * enthaltene Methode onClick wird aufgerufen, wenn auf das MenuItem
	 * "lï¿½schen" geklickt wurde. Dies soll das Element mit dem Namen
	 * lï¿½schen, wenn es nirgendwo gebraucht wurde.
	 * 
	 * @author HackZ
	 * 
	 */
	...
	/**
	 * Dieser Handler sorgt dafï¿½r, dass neu geï¿½ffnete Tabs im
	...
	/**
	 * Dieser Handler wird an den StorageController ï¿½bergeben, der die darin
	 * enthaltene Methode nextMethod aufruft, falls bei Schrittweiser
	 * Ausfï¿½hrung der Tab geï¿½nder werden soll.
	 * 
	 * @author HackZ
	 * 
	 */
